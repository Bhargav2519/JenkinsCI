        ...
        stage('Multi_Lang_Build') {
            steps {
                ...
                script {
                    ...
                    echo "${params.lang}"
                    echo "${params.input}"
                    sh "docker build --network=host -t mavenpipeline --build-arg PARAM1=${GitHub_URL} --build-arg PARAM2=${Branch} /var/lib/jenkins/workspace/MultiLangBuild/dockerfilejava"
                    }
